    ...
    <main className='w-screen flex flex-col items-center py-24 px-6'>
      ...
      <div className='text-left max-w-2xl'>
        <div className='space-y-4 mb-4'>
          ...
          <p>We started working on a <Link to="/work/global-navigation" className ="!underline" target="_blank" rel="noopener noreferrer">navigation redesign</Link>, and part of that work was finding a way to get the navigation UI out of the user’s way – so that they could focus on the task at hand and what was most important. Every time someone had to think twice about how to get to where they needed to be – or hope that they had a Pull Request or Repository URL saved in their URL bar – was a point of friction that added up quickyly.</p>
          <p>We also tasked ourselves with the lofty goal of reframing GitHub’s Core UI as its own "OS", the operating system that the product lives and breathes within. In what ways can we intuit the user wants to move across the product, how can we reduce the friction of context-switching and task completion?</p>
          <p>My initial role in this project was to lead the design exploration and first iteration of the feature. I took on a manager role mid-project and oversaw the design and build of the product, which shipped in 2022.</p>
          <p>Initial blog post: <a href="https://github.blog/changelog/2021-10-27-command-palette-beta/" target="_blank" rel="noopener noreferrer" className="!underline">Introducing the GitHub Command Palette</a></p>
